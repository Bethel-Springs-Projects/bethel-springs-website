      ...
      <div className="mx-auto max-w-[1400px] ">
        <div className="grid gap-4 lg:grid-cols-12 lg:gap-16 ">
          ...
          <div className="lg:col-span-7">
            ...
            <h2 className="font-display mt-4 text-[32px] font-medium leading-[1.05] tracking-tight text-foreground md:text-6xl lg:text-7xl">
              Speak to our team today.
            </h2>
          </div>

          <div className="flex flex-col justify-end lg:col-span-5">
            <p className="text-base md:leading-relaxed text-foreground/70">
