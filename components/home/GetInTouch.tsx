      ...
      <div className="mx-auto max-w-[1400px] ">
        <div className="grid lg:grid-cols-12 lg:gap-16 ">
          <div className="lg:col-span-7">
            <p className="sub-title md:text-start!">— Get in touch</p>
            <h2 className="title md:text-start!">Speak to our team today.</h2>
          </div>

          <div className="flex flex-col justify-end lg:col-span-5">
            <p className="sec-intro md:text-start! md:max-w-xl mx-0!">
              Whether you&apos;re arranging support for yourself, a family
              member or someone in your care, we&apos;re here to listen and help
