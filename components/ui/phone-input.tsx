...
export const PhoneInput = forwardRef<HTMLInputElement, PhoneInputProps>(
  (
    ...
    const inputClasses = cn(
      "flex items-center gap-2 relative bg-transparent transition-colors text-base rounded-md p-0! h-9 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed md:text-sm has-[input:focus]:outline-none has-[input:focus]:ring- has-[input:focus]:ring-ring [interpolate-size:allow-keywords]",
